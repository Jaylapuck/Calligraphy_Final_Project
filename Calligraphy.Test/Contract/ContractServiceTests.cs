...
namespace Calligraphy.Test.Contract
{
    public class ContractServiceTests
    {
        ...
        public void GetContractByIdOk()
        {
            ...
            {
                ContractId = 1, FinalCost = 150.00, DownPayment = 75.00, DateCommissioned = new DateTime(2021, 6, 8),
                EndDate = new DateTime(2021, 7, 8), HasSignature = true, IsFinished = true
            };
        ...
        public void UpdateContractOkResult()
        {
            ...
            var contract = new ContractEntity
            {
                ContractId = 1, FinalCost = 0.0, DownPayment = 0.0, DateCommissioned = new DateTime(2021, 6, 8),
                EndDate = new DateTime(2021, 7, 8), HasSignature = false, IsFinished = false
            };
        ...
        public void UpdateContractBadRequestResult()
        {
            ...
            var UpdateContract = new ContractEntity
            {
                ContractId = 2, FinalCost = 150.00, DownPayment = 75.00, DateCommissioned = new DateTime(2021, 6, 8),
                EndDate = new DateTime(2021, 7, 8), HasSignature = true, IsFinished = true
            };
